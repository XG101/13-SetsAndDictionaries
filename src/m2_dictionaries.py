...
contact = {
    "name": "Johnny",
    "phone": "914-586-0098",
    "email": "chief117@gmail.com",
    "address": "347 Downtown Road, Yonkers, New York"
}
...
accessed_email = contact['email']
print(accessed_email)
...
contact.update({"birthday": "5/15/03"})
print(contact)
